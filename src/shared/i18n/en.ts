...
export const enMessages: Record<MessageKey, string> = {
  ...
  'notificationSettings.pushNote': 'Push delivery needs a real device and APNs/FCM credentials — neither is configured yet, so no device token is registered. These preferences are still saved.',
