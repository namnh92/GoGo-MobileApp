...
export const styles = StyleSheet.create({
  ...
  metaTitle: { fontSize: 14, fontWeight: '700', color: neutral[900] },
  metaLabel: { fontSize: 13, fontWeight: '600', color: neutral[700], marginTop: spacing[2] },
  ...
  chipLabel: { fontSize: 13, color: neutral[700] },
  ...
  submissionStatus: { fontSize: 13, color: neutral[500], marginTop: spacing[2] },
})
